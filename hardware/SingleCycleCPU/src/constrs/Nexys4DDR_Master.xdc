...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { rawClk }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { frequency }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
